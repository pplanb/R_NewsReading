...
restrictedEvents <- read_excel("D:/TradingRepos/R_NewsReading/RestrictedEvents.xlsx",
                               col_names = F)
...
write.csv(todaysEvents, paste("D:/TradingRepos/R_NewsReading/log/log-", Sys.Date(), ".csv", sep = ""))

# write obtained dataframe to all terminals!
#Terminal 1
write.csv(flag, "D:/FxPro - Terminal1/MQL4/Files/01_MacroeconomicEvent.csv", row.names = F)
#Terminal 2
write.csv(flag, "D:/FxPro - Terminal2/MQL4/Files/01_MacroeconomicEvent.csv", row.names = F)
#Terminal 3
write.csv(flag, "D:/FxPro - Terminal3/MQL4/Files/01_MacroeconomicEvent.csv", row.names = F)
